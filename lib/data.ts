...
export const projects = [
  {
    ...
    description: "Reestruturação da página utilizando Django e Python.",
  ...
  {
    title: "CashPilot",
    description: "Aplicação Web/Mobile para controle financeiro utilizando Django.",
    technologies: ["Django", "Web", "Mobile"],
